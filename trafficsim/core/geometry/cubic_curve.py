    ...
    def compute_dx(self, t):
        return (
            ...
            * (
            ...
            + 6 * t * (self.control_2[0] - 2 * self.control_1[0] + self.start[0])
            + 3 * (self.control_1[0] - self.start[0])
        )
    ...
    def compute_dy(self, t):
        return (
            ...
            * (
            ...
            + 6 * t * (self.control_2[1] - 2 * self.control_1[1] + self.start[1])
            + 3 * (self.control_1[1] - self.start[1])
        )
